...
struct ad y[100];
int n,i,j=0,a=0,sum=0,g,flag,num,b=0,d=0;
void read();
void add();
void view();
void search();
...
printf("Disease = ");
puts(y[i].disease);
printf("Cabin no = %d\nPhone number = %d\nAge=%d",y[i].cabin,y[i].phone,y[i].age);
printf("\n\n");
}
}
void edit()
...
printf("Disease = ");
puts(y[s].disease);
printf("Cabin no = %d\nPhone number = 0%d\nAge =%d",y[s].cabin,y[s].phone,y[s].age);
...
printf("Disease = ");
puts(y[g].disease);
printf("Cabin no = %d\nPhone number = 0%d\nAge = %d",y[g].cabin,y[g].phone,y[g].age);
printf("\n\n");
...
if(h==1)
{
strcpy(y[b].name,x[f].name);
strcpy(y[b].disease,x[f].disease);
y[b].age=x[f].age;
